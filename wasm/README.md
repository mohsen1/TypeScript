...
- Overall: Solver/emitter/source-map hardening continues across worker branches; main repo is synced to `origin/rust`; no CLI/LSP feature work in flight.
