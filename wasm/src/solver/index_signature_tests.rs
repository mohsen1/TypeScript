...
fn test_object_with_props_to_index_signature() {
    ...
    let source = interner.object(vec![
        PropertyInfo { name: Arc::from("foo"), type_id: TypeId::NUMBER, optional: false, readonly: false },
        PropertyInfo { name: Arc::from("bar"), type_id: TypeId::NUMBER, optional: false, readonly: false },
    ]);
