...
/// Matches TypeScript's relation types for type compatibility.
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TypeRelation {
    /// Assignment compatibility (most common): source can be assigned to target
    Assignable,
...
impl<'a> CheckerState<'a> {
    ...
    // =========================================================================
    // Type Relationship Checking (isTypeRelatedTo)
    // =========================================================================
