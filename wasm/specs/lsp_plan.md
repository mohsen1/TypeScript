...
- [x] Performance instrumentation
  ...
  - [x] Verify scope cache reuse from hover to definition after edit across files.
  - [x] Verify scope cache reuse from hover to references after edit across files.
  - [x] Verify scope cache reuse from hover to rename after edit across files.
  ...
  - [x] Verify scope cache reuse from hover to rename after edit.
- [x] Cross-file rename
