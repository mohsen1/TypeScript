...
2. Implement remaining directive handlers (arrow, async, modules) [partial: arrow this-capture + async arrow downlevel handled; AMD/UMD/System wrappers auto-lower in legacy ThinPrinter]
