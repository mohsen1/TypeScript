...
7. Deprecate inline transform logic (breaking change) [partial: removed inline ES5 class/enum/namespace/arrow/for-of/async paths; anonymous default export fallback remains]
