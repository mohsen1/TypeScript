...
- [x] Added ES5 async object literal await source map mapping test in `wasm/src/source_map_tests.rs`.
...
- [x] Added ES5 async binary add await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_add_mapping`.
- [x] Added ES5 async binary multiply await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_multiply_mapping`.
- [x] Added ES5 async binary subtract await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_subtract_mapping`.
- [x] Added ES5 async binary divide await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_divide_mapping`.
- [x] Added ES5 async binary modulo await source map mapping test in `wasm/src/source_map_tests.rs`.
...
- [x] Added ES5 async binary strict not-equal await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_strict_not_equal_mapping`.
- [x] Added ES5 async binary greater-equal await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_greater_equal_mapping`.
- [x] Added ES5 async binary less-equal await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_less_equal_mapping`.
- [x] Added ES5 async binary greater-than await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_greater_than_mapping`.
- [x] Added ES5 async binary equal await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_equal_mapping`.
- [x] Added ES5 async binary not-equal await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_not_equal_mapping`.
- [x] Added ES5 async binary bitwise-and await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_bitwise_and_mapping`.
- [x] Added ES5 async binary bitwise-or await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_bitwise_or_mapping`.
- [x] Added ES5 async binary bitwise-xor await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_binary_bitwise_xor_mapping`.
- [x] Added ES5 async destructuring await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_destructuring_mapping`.
- [x] Added ES5 async binary shift-left await source map mapping test in `wasm/src/source_map_tests.rs`.
...
- [x] Added ES5 async logical-or complex await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_logical_or_complex_mapping`.
- [x] Added ES5 async logical-and both-awaits source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_logical_and_both_awaits_mapping`.
- [x] Added ES5 async ternary await-condition source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_ternary_await_condition_mapping`.
- [x] Added ES5 async try/catch/finally await-in-finally source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_try_catch_finally_await_in_finally_mapping`.
- [x] Added ES5 async try/catch/finally await in catch+finally source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_try_catch_finally_catch_finally_awaits_mapping`.
- [x] Added ES5 async assignment await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_assignment_mapping`.
- [x] Added ES5 async unary not await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_unary_not_mapping`.
- [x] Added ES5 async unary plus await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_unary_plus_mapping`.
- [x] Added ES5 async unary negative await source map mapping test in `wasm/src/source_map_tests.rs`.
...
- [x] Added ES5 async unary typeof await source map mapping test in `wasm/src/source_map_tests.rs`.
      Tests: `./wasm/test.sh test_source_map_es5_transform_async_unary_typeof_mapping`.
- [x] Added ES5 async delete await source map mapping test in `wasm/src/source_map_tests.rs`.
