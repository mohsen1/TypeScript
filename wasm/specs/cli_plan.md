...
- Focused parser coverage for checker.ts:15885 (`everyType` arrow with optional chaining + ternary/comma) via `test_thin_parser_checker_every_type_arrow_optional_chain`.
