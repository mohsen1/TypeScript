...
- [x] Solver unsoundness: template literal has apparent string number index in `wasm/src/solver/subtype_tests.rs`. Tests: `./wasm/test.sh test_template_literal_number_index_subtyping`.
