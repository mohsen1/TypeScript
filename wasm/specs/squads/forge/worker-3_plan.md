...
- [ ] Add a void-return exception regression (`() => void` accepts `() => string`) if not already covered, or pull the next unsoundness case from `wasm/specs/TS_UNSOUNDNESS_CATALOG.md`.
