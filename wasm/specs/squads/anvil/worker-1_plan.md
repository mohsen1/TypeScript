...
## Current Assignment
- [ ] Add ES5 class tests for String.fromCodePoint/codePointAt/includes/startsWith/endsWith patterns in `wasm/src/transforms/class_es5_tests.rs`. Run `./wasm/test.sh class_es5_tests`.
