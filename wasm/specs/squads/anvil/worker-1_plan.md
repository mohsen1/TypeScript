...
Priority: 1
## Current Assignment
- [ ] Add ES5 class tests for conditional type patterns: infer keyword in class context, distributive conditionals, Extract/Exclude types. Tests: `./wasm/test.sh class_es5_tests`

## Task Queue
- [ ] Add ES5 class tests for template literal type patterns: string manipulation types, key remapping
