...
## Current Assignment
- [ ] Add ES5 class tests for Number.isFinite/isNaN/isInteger/isSafeInteger patterns in `wasm/src/transforms/class_es5_tests.rs`. Run `./wasm/test.sh class_es5_tests`.
