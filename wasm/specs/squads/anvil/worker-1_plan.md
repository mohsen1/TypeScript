...
Priority: 1
## Current Assignment
Add ES5 class tests for declaration merging patterns: interface, namespace, function. Tests: `./wasm/test.sh class_es5_tests`

## Task Queue
- [ ] Add ES5 class tests for ambient module patterns: declare module, global augmentation
