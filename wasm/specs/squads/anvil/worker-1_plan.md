...
## Current Assignment
- Complete: Added helper ordering regression to ensure `__awaiter` precedes `__generator` in helpers output; ran `./wasm/test.sh` (fails: `parallel::tests::test_check_redux_lodash_style_generics`).
