...
## Current Assignment
- [ ] Add ES5 class tests for const assertions in `wasm/src/transforms/class_es5_tests.rs`. Run `./wasm/test.sh class_es5_tests`.

## Task Queue
- [ ] (empty)

## Completed
- [x] Added ES5 tests for satisfies expressions. Tests: `./wasm/test.sh class_es5_tests`
