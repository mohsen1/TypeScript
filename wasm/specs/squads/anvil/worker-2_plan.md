...
## Current Assignment
- [ ] Add ES5 parity tests for for-await-of patterns: async iteration with destructuring, async iteration in class, error handling. Tests: `./wasm/test.sh emitter_parity`
