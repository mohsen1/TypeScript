...
## Current Assignment
Add ES5 union/intersection type patterns parity tests

Per GOALS.md Objective 1: ES5 downleveling correctness

Steps:
1. Add 6 ES5 union/intersection type parity tests to `wasm/src/thin_emitter/emitter_parity_tests.rs`:
   - Basic union type
   - Discriminated union
   - Intersection type
   - Union with null/undefined
   - Complex intersection patterns
   - Combined union/intersection patterns
2. Run `./wasm/test.sh emitter_parity` to verify all tests pass
3. Commit with message: `[wasm] emitter: add union/intersection parity tests`
