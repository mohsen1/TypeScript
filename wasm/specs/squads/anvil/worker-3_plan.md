...
## Current Assignment
Add ES5 source map tests for nullish coalescing patterns: basic, with optional chaining. Tests: `./wasm/test.sh source_map_tests`

## Task Queue
- [ ] Add ES5 source map tests for logical assignment patterns: &&=, ||=, ??=
