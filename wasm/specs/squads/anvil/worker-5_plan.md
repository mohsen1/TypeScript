...
## Current Assignment
- [ ] Add async ES5 tests for async iterator patterns: next, return, throw, for-await-of. Tests: `./wasm/test.sh async_es5_tests`

## Task Queue
- [ ] Add async ES5 tests for async generator delegation patterns: yield*, nested
