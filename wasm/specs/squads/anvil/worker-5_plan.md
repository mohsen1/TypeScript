...
## Current Assignment
- [ ] Add ES5 async tests for Promise combinators (Promise.all, Promise.race, Promise.allSettled) in `wasm/src/transforms/async_es5_tests.rs`. Run `./wasm/test.sh async_es5_tests`.
