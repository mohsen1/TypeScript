//! TypeScript Binder Library
//!
//! This library provides a Rust implementation of the TypeScript binder,
...
//!
//! ```rust
//! use ts_binder::{Binder, ScopeKind};
//!
//! let mut binder = Binder::new();
//!
//! // Declare a variable
//! let symbol_id = binder.bind_variable_declaration("x", 1, false, true).unwrap();
//!
//! // Enter a function scope
//! binder.enter_scope(ScopeKind::Function);
//!
//! // Declare a local variable
//! binder.bind_variable_declaration("y", 2, false, true).unwrap();
//!
//! // Look up symbols
//! assert!(binder.lookup_symbol("x").is_some()); // Found in parent scope
//! assert!(binder.lookup_symbol("y").is_some()); // Found in current scope
//!
//! binder.exit_scope();
//!
//! // y is no longer visible
//! assert!(binder.lookup_symbol("y").is_none());
//! ```
...
pub use container::{ContainerInfo, ContainerStack, ContainerFlags, NodeFlags, HoistingInfo, NodeId};
