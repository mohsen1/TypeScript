...
You are the Director. Read PROJECT_DIRECTION.md and create a work distribution plan.
...
3. Break down the project into tasks suitable for 14 workers
...
- **Mode:** hierarchy
- **Team:** em-team-1
- **Task ID:** 96b4a926-4ecb-4097-a82a-dcfd6cbe65e2
- **Priority:** high
